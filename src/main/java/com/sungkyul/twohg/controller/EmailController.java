...
import com.sungkyul.twohg.service.EmailService;
...
public class EmailController {
    ...
    public String write() {
        return "write"; // 다시 write jsp 페이지로 이동하고 jsp페이지에서 내용을 다 채운 뒤에 확인 버튼을 누르면 send.do로 넘어감
    }
    ...
    public String send(@ModelAttribute EmailDto dto, Model model) {
        ...
        return "write"; // 실패했으므로 다시 write jsp 페이지로 이동함
    }
}
